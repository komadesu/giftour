...
const GetForm = () => {
  return (
    <div className="get-form">
      <div className="get-form__title">
        <label htmlFor="title">もらったもの：</label>
        <input type="text" id="title" />
      </div>
      <div className="get-form__brand">
        <label htmlFor="brand">ブランド / メーカー等：</label>
        <input type="text" id="brand" />
      </div>
      <div className="get-form__age">
        <label htmlFor="age">相手の年齢：</label>
        <input type="number" id="age" />
      </div>
      <div className="get-form__relation">
      ...
      <div className="get-form__gender">
      ...
      <div className="get-form__category">
      ...
      <div className="get-form__situation">
      ...
      <div className="get-form__preview">
      ...
      <div className="get-form__btn-wrapper">
        <input className="btn get-form-btn" type="button" value="Upload" />
      </div>
    </div>
  );
};
